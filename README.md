...
A token is used for authorization. it allows a user's information to be secure and grants access to the right people

2. What steps can you take in your web apps to keep your data secure?
using privateRoutes and only granting access to people with the proper token

3. Describe how web servers work.
a web server processes incoming requests (get,post,delete and others). it checks if the user has the proper credentials and sends back information to the user
